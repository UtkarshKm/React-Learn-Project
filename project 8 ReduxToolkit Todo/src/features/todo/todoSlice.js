...
export const {addtodo , deletetodo} = todoSlice.actions  // individual export of reducers functions to use in components
export default todoSlice.reducer // export of reducer to use in store.js  
